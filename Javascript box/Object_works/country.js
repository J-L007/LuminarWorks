...
for(let country of countries){
    ...
    let country_pop=country.population
    let currency_name="NA"
    let capital=country.capital
    if("currencies" in country){
        currency_name=country.currencies[0].name
    }
    let obj={country_name,country_pop,currency_name,capital}
    mycountries.push(obj)
}
// console.log(mycountries);
// mycountries.forEach(data=>console.log(data.country_name))

// find data of india?
// let Ind_data=mycountries.find(a=>a.country_name=="India")
// console.log(Ind_data);


// find currency of china?
// let china_cur=mycountries.find(a=>a.country_name=="China").currency_name
// console.log(china_cur);
mycountries.filter(data=>data.country_pop>20000000).map(region=>region.country_name).forEach(r_name=>console.log(r_name))